...
export default function Dashboard() {
    ...
    return (
        <div className="page-transition overflow-auto relative flex flex-col h-full pt-16">
            ...
            <div
                className="relative mt-24 flex flex-col gap-5 justify-between w-full h-full bg-background-new-4/80 py-8  px-4 text-sm text-text-new-1 rounded-t-2xl">
                ...
                <div className="h-64 w-full px-5 pt-5 pb-2 bg-background-new-3/80 rounded-xl flex flex-col items-center">
                    ...
                    <div className="pt-8 h-full w-full flex flex-col justify-between items-center">
                ...
                <nav className="self-center flex  justify-between items-center px-5 gap-4 rounded-4xl h-10 sm:h-12 bg-background-new-3">
                    <div>
                        <House className="h-5 w-5 sm:h-8 sm:w-8 text-white transition duration-200 hover:scale-110" />
                    </div>
                    <div className="transition duration-200 w-14 h-14 sm:h-16 sm:w-16 rounded-full bg-primary-new-1 flex items-center justify-center">
