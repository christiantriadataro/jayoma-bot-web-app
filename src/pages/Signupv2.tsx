...
export default function Signupv2() {
    ...
    return (
        <div className="page-transition overflow-auto relative flex flex-col h-full pt-16">
            ...
            <h1 className="font-medium text-xs sm:text-sm text-text-new-1">Please put your information below to create a new account for using this app.</h1>
            </div>
            <div className="mt-10 w-full h-full bg-background-new-4/75 py-4 sm:py-8 space-y-4 sm:space-y-5 px-4 text-[10px] sm:text-sm text-text-new-1 rounded-t-xl sm:rounded-t-2xl">
