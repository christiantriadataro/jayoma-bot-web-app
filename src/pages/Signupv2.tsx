        ...
        <div className="page-transition overflow-auto relative flex flex-col h-full pt-16">
            ...
            <div
                ...
                <div className="mt-5 flex gap-4 items-start">
                    ...
                    <div className="">I agree to Jayoma AI Chatbot <span className="text-primary-new-1">License Agreement, Terms & Privacy Policy</span>
                    </div>
                </div>
                <div onClick={handleClick}
                     className="mt-8 bg-primary-new-1 py-3 flex font-bold justify-center items-center rounded-lg text-white">Register
                    Now
                </div>
            </div>
        </div>
